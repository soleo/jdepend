...
public class PackageFilter_T {
     ...
     */
    public PackageFilter_T(File f) {
        this(new ArrayList());
        PropertyConfigurator_T config = new PropertyConfigurator_T(f);
        addPackages(config.getFilteredPackages());
    }
     ...
     */
    public PackageFilter_T(Collection packageNames) {

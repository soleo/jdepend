...
public class PropertyConfigurator_T {
     ...
     */
    public PropertyConfigurator_T(Properties p) {
        this.properties = p;
    }
     ...
     */
    public PropertyConfigurator_T(File f) {
    ...
    public Collection getConfiguredPackages() {
        ...
        while (e.hasMoreElements()) {
            ...
            if (!key.startsWith("ignore")
                ...
                packages.add(new JavaPackage_T(key, new Integer(v).intValue()));
            }
        }
    ...
    public static Properties loadProperties(File file) {
        ...
        try {
            ...
            is = PropertyConfigurator_T.class.getResourceAsStream("/"
